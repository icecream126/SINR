...
if __name__=='__main__':
    ...
    # Data
    train_dataset = GraphDataset(dataset_type='train', **vars(args))
    valid_dataset = GraphDataset(dataset_type='valid', **vars(args))
    test_dataset = GraphDataset(dataset_type='test', **vars(args))
