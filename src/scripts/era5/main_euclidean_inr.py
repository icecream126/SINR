...
if __name__=='__main__':
    ...
    # Data
    train_dataset = ERA5EuclideanDataset(dataset_type='train',**vars(args))
    test_dataset = ERA5EuclideanDataset(dataset_type='test',**vars(args))
    need_time=False
    ...
    model = EuclideanINR(need_time, input_dim, output_dim, len(train_dataset), **vars(args))
