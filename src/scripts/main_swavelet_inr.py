...
if __name__=='__main__':
    ...
    train_dataset = SwaveletDataset(**vars(args))
    args.dataset_type = 'valid'
    valid_dataset = SwaveletDataset(**vars(args))
    args.dataset_type = 'test'
    test_dataset = SwaveletDataset(**vars(args))
    ...
    logger = WandbLogger(
        ...
        save_dir="experiment", 
        name='spherical_wavelet/'+str(args.dataset_dir[8:])
        )
