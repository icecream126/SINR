...
from utils.posenc import OneHealEncoding
...
class INR(MODEL):
    def __init__(
        ...
        **kwargs,
        ...
        self.posenc = OneHealEncoding(n_levels=n_levels, F=n_features_per_level, great_circle=great_circle)
        self.posenc_dim = n_features_per_level 
