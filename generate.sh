...
python src/datasets/generation/era5.py --variable=cloud_cover --mode=single --level_type=pressure --years=2000 --resolution=0.25 --month=01 --day=01 --time=00:00 --pressure_level=850 --custom_fn=data.nc --output_dir=dataset/spatial_0_25/era5_cloud
...
python src/datasets/generation/era5.py --variable=cloud_cover --mode=single --level_type=pressure --years=2000 --resolution=0.50 --month=01 --day=01 --time=00:00 --pressure_level=850 --custom_fn=data.nc --output_dir=dataset/spatial_0_50/era5_cloud
...
python src/datasets/generation/era5.py --variable=cloud_cover --mode=single --level_type=pressure --years=2000 --resolution=2.8125 --month=01 --day=01 --time=00:00 --pressure_level=850 --custom_fn=data.nc --output_dir=dataset/spatial_2_8125/era5_cloud
