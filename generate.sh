...
python src/datasets/generation/era5.py --variable=u_component_of_wind --mode=separate --level_type=pressure --resolution=2.8125 --pressure_level=500 --custom_fn=data.nc --output_dir=dataset/temporal/era5_wind
python src/datasets/generation/era5.py --variable=cloud_cover --mode=separate --level_type=pressure --resolution=2.8125 --pressure_level=500 --custom_fn=data.nc --output_dir=dataset/temporal/era5_cloud_cover
